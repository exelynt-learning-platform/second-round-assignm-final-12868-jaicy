...
import com.multigenesis.ecomm_assesment.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getAllProducts(
            ...
            @RequestParam(name = "sortBy", defaultValue = PaginationSortingConstants.SORT_PRODUCTS_BY, required = false) String sortBy,
